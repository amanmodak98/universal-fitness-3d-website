  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-32 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <p className="text-[#ff3d2e] tracking-[0.3em] text-sm mb-4">YOUR PATH</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Connection line */}
            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#ff3d2e] via-[#e62414] to-[#ff3d2e] hidden md:block" />
                ...
                >
                  ...
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'} text-left`}>
                    ...
                    >
                      ...
                      <h3 className="text-2xl md:text-3xl font-black text-[#ff3d2e] mb-2 font-display" >
                        {step.title}
                      </h3>
                  ...
                  <div className="hidden md:flex items-center justify-center w-16 h-16 flex-shrink-0">
                    <motion.div
                      className="w-6 h-6 bg-gradient-to-br from-[#ff3d2e] to-[#e62414] rounded-full"
        ...
        >
          ...
          <motion.a
            href="#contact"
            className="inline-block px-10 py-4 bg-gradient-to-r from-[#ff3d2e] to-[#e62414] text-black font-bold rounded-full text-lg hover:shadow-xl hover:shadow-[#ff3d2e]/30 transition-all duration-300"
